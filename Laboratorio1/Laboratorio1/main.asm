...
SETUP:
	...
	LDI		R16, 0b0000_0100	
	STS		CLKPR, R16			;SELECCIONAL EL PRESCALER DE 1MHz
...
LOOP:
	CALL	AUMENTAR_1			;LLAMA A LA SUBRUTINA QUE INCREMENTA EL NUMERO 1
	CALL	DECREMENTAR_1		;LLAMA A LA SUBRUTINA QUE DECREMENTA EL NUMERO 1

	CALL	AUMENTAR_2			;LLAMA A LA SUBRUTINA QUE INCREMENTA EL NUMERO 2
	CALL	DECREMENTAR_2		;LLAMA A LA SUBRUTINA QUE DECREMENTA EL NUMERO 2

	CALL	RESULTADO			;LLAMA A LA SUBRUTINA QUE MUESTRA EL RESULTADO 
	RJMP	LOOP 
...
AUMENTAR_2:
	SBIS	PINB, PB2			;VERIFICA SI EL BIT 0 DEL PUERTO B ES IGUAL A 1 
	RET							;SI EL BIT 2 ES IGUAL A 0 
	CALL	RETARDO				;SI EL BIT 2 ES IGUAL A 1
CONFIRMAR_C:
	SBIC	PINB, PB2			;VERIFICA SI EL BIT 0 DEL PUERTO B ES IGUAL A 0 
	RJMP	CONFIRMAR_C			;SI EL BIT 2 ES IGUAL A 1
	INC		R19					;INCREMENTA EL NUMERO 2
	MOVW	R20, R18			;COPIA EL NUMERO 1 PARA CAMBIAR LOS NIBLES
	SWAP	R20					;CAMBIA LOS NIBLES (MASCARA)
	ADD		R20, R19			;SUMA EL NUMERO 1 Y NUMERO 2 PARA MOSTRARLO EN UN SOLO PUERTO
	OUT		PORTD,R20			;MUESTRA EN EL PUERTO D
...
DECREMENTAR_2:
	SBIS	PINB, PB3			;VERIFICA SI EL BIT 1 DEL PUERTO B ES IGUAL A 1 
	RET							;SI EL BIT 3 ES IGUAL A 0 
	CALL	RETARDO				;SI EL BIT 3 ES IGUAL A 1
CONFIRMAR_D:
	SBIC	PINB, PB3			;VERIFICA SI EL BIT 1 DEL PUERTO B ES IGUAL A 0 
	RJMP	CONFIRMAR_D			;SI EL BIT 3 ES IGUAL A 1
	DEC		R19					;DECREMENTA EL NUMERO 2
	MOVW	R20, R18			;COPIA EL NUMERO 1 PARA CAMBIAR LOS NIBLES
	SWAP	R20					;CAMBIA LOS NIBLES (MASCARA)
	ADD		R20, R19			;SUMA EL NUMERO 1 Y NUMERO 2 PARA MOSTRARLO EN UN SOLO PUERTO
	OUT		PORTD,R20			;MUESTRA EN EL PUERTO D
...
INCR17:
	...
	CPI		R17, 255			;SI R17 = 0?
	BRNE	INCR17				;SI R17 != 0
INCR16:
	INC		R16					;INCREMENTA R16
	CPI		R16, 1				;SI R16 = 1?
	BRNE	INCR16				;SI R17 != 1
	RET